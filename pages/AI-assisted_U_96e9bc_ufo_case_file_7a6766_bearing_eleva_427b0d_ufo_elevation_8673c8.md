...
title_full: How high was the light really? | Geometry
...
* a little finger is close to 1° to 2° depending on the method used Chandra Observatory <span class="citation-chip-wrap"><a class="citation-chip" href="https://earthsky.org/astronomy-essentials/sky-measurements-degrees-arc-minutes-arc-seconds/" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: earthsky.org">[EarthSky]</a><span class="citation-popover" role="note"><span class="citation-popover-source">earthsky.org</span><span class="citation-popover-snippet">EarthSkySky measurements: Degrees, arcminutes and arcseconds1 Jan 2026 — The general rule amateur astronomers use is that the width of yo...</span></span></span> <span class="citation-chip-wrap"><a class="citation-chip" href="https://www.abc.net.au/science/articles/2009/07/27/3169109.htm" target="_blank" rel="noopener noreferrer nofollow" aria-label="View source: abc.net.au">[ABC News]</a><span class="citation-popover" role="note"><span class="citation-popover-source">abc.net.au</span><span class="citation-popover-snippet">Measure the sky with your hands27 July 2009 — Raise your three middle fingers to measure 5 degrees. Clench your fist or hold your hand li...</span><span class="citation-popover-meta">Published: July 2009</span></span></span>
...
The Moon is especially useful because many people instinctively remember an object's position relative to it. The Moon’s apparent width is about half a degree, providing a familiar angular [reference]({{ 'reference-points/' | relative_url }}). Even imperfect comparisons can help investigators estimate scale and height relationships.
...
The first is analytical distortion. If a report states that an object was observed at “exactly 52° elevation”, later investigators may treat that value as instrument-grade data. Automated systems can then exclude [plausible]({{ 'plausible-cases/' | relative_url }}) explanations incorrectly because the input appears more certain than it really is.
...
A [case file]({{ 'case-file/' | relative_url }}) should reflect that hierarchy clearly.
