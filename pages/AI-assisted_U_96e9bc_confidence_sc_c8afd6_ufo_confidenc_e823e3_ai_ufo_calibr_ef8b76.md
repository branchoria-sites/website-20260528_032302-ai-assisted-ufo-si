...
title_full: When AI Confidence Scores Stop Matching Reality | Calibration
...
* Uncertain [timestamp]({{ 'sky-checks/' | relative_url }})
...
* [Infrared]({{ 'infrared-orbs/' | relative_url }}) glare events
