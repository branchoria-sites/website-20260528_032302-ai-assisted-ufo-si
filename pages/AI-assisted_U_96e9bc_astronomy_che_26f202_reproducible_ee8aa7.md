...
- AI-assisted_U_96e9bc_astronomy_che_26f202_reproducible_ee8aa7_index
...
show_ads: true
description: Saved sky maps and ephemeris tables let later reviewers test whether a proposed astronomy match really fits the sighting.
hero_summary: Saved sky maps and ephemeris tables let later reviewers test whether a proposed astronomy match really fits the sighting.
layout: default
permalink: /sky-maps/
...
page_heading_title: How to make a UFO sky check repeatable
source_count: 52
infographic_count: 3
planned_sections:
...
* [confidence]({{ 'confidence/' | relative_url }}) levels for coordinates
...
* haze
* low cloud
* [scintillation]({{ 'scintillation/' | relative_url }})
* twilight brightness
